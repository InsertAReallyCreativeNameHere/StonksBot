...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "master"
  WORKING_DIRECTORY "D:/Github/StonksBot/dependencies/sleepy-discord/deps/websocketpp"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Github/StonksBot/dependencies/sleepy-discord/deps/websocketpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Github/StonksBot/dependencies/sleepy-discord/deps/websocketpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
