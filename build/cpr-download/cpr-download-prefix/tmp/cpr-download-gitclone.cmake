...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "D:/Github/StonksBot/dependencies/sleepy-discord/deps/cpr"
  RESULT_VARIABLE error_code
  )
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: 'D:/Github/StonksBot/dependencies/sleepy-discord/deps/cpr'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: 'D:/Github/StonksBot/dependencies/sleepy-discord/deps/cpr'")
endif()
