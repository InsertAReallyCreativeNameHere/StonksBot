...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "D:/Git/cmd/git.exe" rev-parse "${ref}"
    WORKING_DIRECTORY "D:/Github/StonksBot/dependencies/sleepy-discord/deps/cpr"
...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "e627e47"
  WORKING_DIRECTORY "D:/Github/StonksBot/dependencies/sleepy-discord/deps/cpr"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("e627e47" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/e627e47")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Github/StonksBot/dependencies/sleepy-discord/deps/cpr'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Github/StonksBot/dependencies/sleepy-discord/deps/cpr'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
