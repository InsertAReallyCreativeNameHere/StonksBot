...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "e627e47"
  WORKING_DIRECTORY "C:/Users/Administrator/Documents/GitHub/StonksBot/dependencies/sleepy-discord/deps/cpr"
...
if("${show_ref_output}" MATCHES "refs/remotes/e627e47")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "e627e47")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Administrator/Documents/GitHub/StonksBot/dependencies/sleepy-discord/deps/cpr'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Administrator/Documents/GitHub/StonksBot/dependencies/sleepy-discord/deps/cpr'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
